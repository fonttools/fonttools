#FLM: Batch export glyphs to tagged text 

#	Paul van der Laan, 2004/10/26
...
if mySource is not None:
	myPath = mySource + ":glyph overview.txt"
	myTaggedfile = open(myPath, "w")
	myTaggedfile.write("<ASCII-MAC>" + chr(10))
	myTaggedfile.write("<vsn:2.000000><fset:InDesign-Roman><ctable:=<Black:COLOR:CMYK:Process:0.000000,0.000000,0.000000,1.000000>>")
	myPagebreak = ""
