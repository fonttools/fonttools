...
class MtiTest(unittest.TestCase):
    ...
    def check_mti_file(self, name, tableTag=None):
        ...
        self.expect_ttx(xml_binary,   xml_built,
                        fromfile='decompiled',      tofile='built')
        self.expect_ttx(xml_expected, xml_built,
                        fromfile=xml_expected_path, tofile='built')
        ...
        self.expect_ttx(xml_expected, xml_fromxml,
                        fromfile=xml_expected_path, tofile='fromxml')
