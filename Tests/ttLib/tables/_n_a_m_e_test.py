...
class NameTableTest(unittest.TestCase):
    ...
    def test_setName(self):
        ...
        self.assertEqual("Version 1.000", table.getName(
            5, 3, 1, 0x409).toUnicode())
    ...
    def test_findMultilingualNameNoMac(self):
        ...
        self.assertEqual(nameID, table.findMultilingualName(
            namesSubSet, mac=False))
    ...
    def test_addMultilingualName_minNameID(self):
        ...
        self.assertEqual(
            nameID, table.findMultilingualName(names, minNameID=256))
