...
class CmapSubtableTest(unittest.TestCase):
    ...
    def test_buildReversed(self):
        ...
        cmap = table__c_m_a_p()
        cmap.tables = [c4, c12]
        self.assertEqual(cmap.buildReversed(), {
                         'A': {0x0041, 0x0391}, 'u10314': {0x10314}})
    ...
    def test_getBestCmap(self):
        ...
        self.assertEqual(cmap.getBestCmap(cmapPreferences=[(3, 1)]), {
                         0x0041: 'A', 0x0391: 'A'})
    ...
    def test_font_getBestCmap(self):
        ...
        self.assertEqual(font.getBestCmap(cmapPreferences=[(3, 1)]), {
                         0x0041: 'A', 0x0391: 'A'})
