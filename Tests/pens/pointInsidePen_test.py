...
class PointInsidePenTest(unittest.TestCase):
    ...
    def test_contour_decimals(self):
        def draw_contour(pen):
            ...
            pen.curveTo((487.328125, 719.359375), (507.84375,
                                                   783.140625), (555.796875, 783.140625))
            pen.lineTo((717.96875, 783.140625))
            pen.curveTo((738.890625, 783.140625),
                        (748.796875, 711.5), (727.546875, 697.0))
            pen.closePath()

        # this point is outside
        piPen = PointInsidePen(None, (416.625, 783.140625))
        draw_contour(piPen)
        self.assertEqual(piPen.getWinding(), 0)
    ...
    def test_contour2_decimals(self):
        def draw_contour(pen):
            ...
            pen.curveTo((82.5, 49.09375), (82.265625, 48.265625),
                        (82.234375, 47.375))
            pen.closePath()
