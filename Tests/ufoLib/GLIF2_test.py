...
class TestGLIF2(unittest.TestCase):
    ...
    def pyToGLIF(self, py):
        ...
        glif = writeGlyphToString(glyph.name, glyphObject=glyph,
                                  drawPointsFunc=glyph.drawPoints, formatVersion=2, validate=True)
    ...
    def glifToPy(self, glif):
        ...
        glyph = Glyph()
        readGlyphFromString(glif, glyphObject=glyph,
                            pointPen=glyph, validate=True)
        return glyph.py()
