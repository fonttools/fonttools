...
class ToFeaTest(unittest.TestCase):
    ...
    def test_substitution_reverse_chaining_single(self):
        fea = self.parse(
            ...
            'DEF_GLYPH "eight" ID 210 UNICODE 56 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "nine" ID 210 UNICODE 57 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "zero.numr" ID 163 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "one.numr" ID 194 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "two.numr" ID 195 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "three.numr" ID 196 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "four.numr" ID 197 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "fize.numr" ID 165 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "six.numr" ID 209 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "seven.numr" ID 210 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "eight.numr" ID 210 TYPE BASE END_GLYPH\n'
            'DEF_GLYPH "nine.numr" ID 210 TYPE BASE END_GLYPH\n'
