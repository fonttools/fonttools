...
class CmapMergeUnitTest(unittest.TestCase):
    ...
    def test_cmap_merge_no_dupes(self):
        ...
        table2.tables = [self.makeSubtable(
            4, 3, 1, cmap2), self.makeSubtable(12, 3, 10, cmap2Extended)]
    ...
    def test_cmap_merge_three_dupes(self):
        ...
        self.assertEqual((table.format, table.platformID,
                          table.platEncID, table.language), (4, 3, 1, 0))
        self.assertEqual(table.cmap, expectedCmap)
        self.assertEqual(self.merger.duplicateGlyphsPerFont,
                         [{}, {'space#0': 'space#1'}])
