...
The following tables are currently supported::
    ...
    VARC, VDMX, VORG, VVAR, ankr, avar, bdat, bgcl, bhed, bloc, bsln,
    cidg, cmap, cvar, cvt, feat, fpgm, fvar, gasp, gcid, glyf, gvar,
    hdmx, head, hhea, hmtx, kern, lcar, loca, ltag, maxp, meta, mort,
    morx, name, opbd, post, prep, prop, sbix, trak, vhea and vmtx
