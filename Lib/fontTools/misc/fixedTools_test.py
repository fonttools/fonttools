...
class FixedToolsTest(unittest.TestCase):
    ...
    def test_fixedToFloat_precision14(self):
        self.assertAlmostEqual(0.79999, fixedToFloat(13107, 14))
        self.assertAlmostEqual(1.0, fixedToFloat(0x4000, 14))
        self.assertAlmostEqual(-1.0, fixedToFloat(-16384, 14))
        self.assertAlmostEqual(-0.99994, fixedToFloat(-16383, 14))
        self.assertAlmostEqual(0.99994, fixedToFloat(16383, 14))
        self.assertAlmostEqual(1.0, fixedToFloat(16384, 14))
