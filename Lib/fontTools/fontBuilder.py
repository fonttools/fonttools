...
class FontBuilder(object):
    ...
    def setupOS2(self, **values: Any) -> None:
    ...
    def setupPost(self, keepGlyphNames: bool = True, **values: Any) -> None:
    ...
    def addFeatureVariations(
        self, conditionalSubstitutions, featureTag: str = "rvrn"
    ) -> None:
