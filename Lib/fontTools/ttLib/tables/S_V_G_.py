...
doc_index_entry_format_0 = """
	>   # big endian
	startGlyphID:             H  # py:"int | None"
	endGlyphID:               H  # py:"int | None"
	svgDocOffset:             L  # py:"int | None"
	svgDocLength:             L  # py:"int | None"
"""
...
class DocumentIndexEntry(object):
    binaryFormat = doc_index_entry_format_0

    # BEGIN sstruct decode -- generated by MetaTools/buildTableStubs.py
    endGlyphID: int | None
    startGlyphID: int | None
    svgDocLength: int | None
    svgDocOffset: int | None
    # END sstruct decode
