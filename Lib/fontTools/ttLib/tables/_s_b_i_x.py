...
class table__s_b_i_x(DefaultTable.DefaultTable):
    ...
    def decompile(self, data, ttFont):
        ...
        for i in range(self.numStrikes):
            current_offset = sbixHeaderFormatSize + \
                i * sbixStrikeOffsetFormatSize
        ...
        # after the glyph data records have been extracted, we don't need the
        # offsets anymore
    ...
    def compile(self, ttFont):
        ...
        setOffset = sbixHeaderFormatSize + \
            sbixStrikeOffsetFormatSize * self.numStrikes
