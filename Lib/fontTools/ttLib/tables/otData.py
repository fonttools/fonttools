...
otData = [
    ...
    ('LangSys', [
        ...
        ('uint16', 'FeatureIndex', 'FeatureCount', 0,
    ...
    ('Feature', [
        ('Offset', 'FeatureParams', None, None,
         '= NULL (reserved for offset to FeatureParams)'),
        ('uint16', 'LookupCount', None, None,
    ...
    ('FeatureParamsCharacterVariants', [
        ...
        ('NameID', 'FeatUILabelNameID', None,
         None, 'Feature UI label NameID.'),
        ('NameID', 'FeatUITooltipTextNameID', None,
         None, 'Feature UI tooltip text NameID.'),
        ('NameID', 'SampleTextNameID', None, None, 'Sample text NameID.'),
        ('uint16', 'NumNamedParameters', None,
         None, 'Number of named parameters.'),
        ('NameID', 'FirstParamUILabelNameID', None,
         None, 'First NameID of UI feature parameters.'),
        ('uint16', 'CharCount', None, None,
         'Count of characters this feature provides glyph variants for.'),
        ('uint24', 'Character', 'CharCount', 0,
    ...
    ('Lookup', [
        ('uint16', 'LookupType', None, None,
         'Different enumerations for GSUB and GPOS'),
        ('LookupFlag', 'LookupFlag', None, None, 'Lookup qualifiers'),
        ('uint16', 'SubTableCount', None, None,
         'Number of SubTables for this lookup'),
        ('Offset', 'SubTable', 'SubTableCount', 0,
    ...
    ('CoverageFormat1', [
        ...
        ('GlyphID', 'GlyphArray', 'GlyphCount', 0,
    ...
    ('CoverageFormat2', [
        ...
        ('struct', 'RangeRecord', 'RangeCount', 0,
    ...
    ('ClassDefFormat1', [
        ...
        ('uint16', 'ClassValueArray', 'GlyphCount',
         0, 'Array of Class Values-one per GlyphID'),
    ]),

    ('ClassDefFormat2', [
        ('uint16', 'ClassFormat', None, None, 'Format identifier-format = 2'),
        ('uint16', 'ClassRangeCount', None,
         None, 'Number of ClassRangeRecords'),
        ('struct', 'ClassRangeRecord', 'ClassRangeCount', 0,
    ...
    ('ClassRangeRecord', [
        ('GlyphID', 'Start', None, None, 'First GlyphID in the range'),
        ('GlyphID', 'End', None, None, 'Last GlyphID in the range'),
        ('uint16', 'Class', None, None,
         'Applied to all glyphs in the range'),
    ]),

    ('Device', [
        ('uint16', 'StartSize', None, None, 'Smallest size to correct-in ppem'),
        ('uint16', 'EndSize', None, None,
         'Largest size to correct-in ppem'),
        ('uint16', 'DeltaFormat', None, None,
         'Format of DeltaValue array data: 1, 2, or 3'),
        ('DeltaValue', 'DeltaValue', '',
         'DeltaFormat in (1,2,3)', 'Array of compressed data'),
    ]),
    ...
    ('GPOS', [
        ...
        ('Offset', 'ScriptList', None, None,
         'Offset to ScriptList table-from beginning of GPOS table'),
        ('Offset', 'FeatureList', None, None,
         'Offset to FeatureList table-from beginning of GPOS table'),
        ('Offset', 'LookupList', None, None,
    ...
    ('SinglePosFormat2', [
        ...
        ('ValueRecord', 'Value', 'ValueCount', 0,
    ...
    ('PairValueRecord', [
        ...
        ('ValueRecord', 'Value1', None, None,
         'Positioning data for the first glyph in the pair'),
        ('ValueRecord', 'Value2', None, None,
    ...
    ('CursivePosFormat1', [
        ...
        ('uint16', 'EntryExitCount', None,
         None, 'Number of EntryExit records'),
        ('struct', 'EntryExitRecord', 'EntryExitCount', 0,
    ...
    ('LigatureAttach', [
        ('uint16', 'ComponentCount', None, None,
         'Number of ComponentRecords in this ligature'),
        ('struct', 'ComponentRecord', 'ComponentCount', 0,
    ...
    ('Mark2Array', [
        ...
        ('struct', 'Mark2Record', 'Mark2Count', 0,
    ...
    ('PosLookupRecord', [
        ('uint16', 'SequenceIndex', None, None,
         'Index to input glyph sequence-first glyph = 0'),
        ('uint16', 'LookupListIndex', None, None,
    ...
    ('ContextPosFormat1', [
        ...
        ('uint16', 'PosRuleSetCount', None,
         None, 'Number of PosRuleSet tables'),
    ...
    ('PosRule', [
        ...
        ('struct', 'PosLookupRecord', 'PosCount', 0,
    ...
    ('ContextPosFormat2', [
        ...
        ('Offset', 'Coverage', None, None,
         'Offset to Coverage table-from beginning of ContextPos subtable'),
        ('Offset', 'ClassDef', None, None,
         'Offset to ClassDef table-from beginning of ContextPos subtable'),
        ('uint16', 'PosClassSetCount', None,
         None, 'Number of PosClassSet tables'),
    ...
    ('PosClassSet', [
        ('uint16', 'PosClassRuleCount', None,
         None, 'Number of PosClassRule tables'),
    ...
    ('ChainContextPosFormat1', [
        ...
        ('Offset', 'Coverage', None, None,
         'Offset to Coverage table-from beginning of ContextPos subtable'),
        ('uint16', 'ChainPosRuleSetCount', None,
         None, 'Number of ChainPosRuleSet tables'),
    ...
    ('ChainPosRuleSet', [
        ('uint16', 'ChainPosRuleCount', None,
         None, 'Number of ChainPosRule tables'),
    ...
    ('ChainContextPosFormat2', [
        ...
        ('uint16', 'ChainPosClassSetCount', None,
         None, 'Number of ChainPosClassSet tables'),
    ...
    ('ChainPosClassSet', [
        ('uint16', 'ChainPosClassRuleCount', None,
         None, 'Number of ChainPosClassRule tables'),
    ...
    ('AnchorFormat1', [
        ...
        ('int16', 'XCoordinate', None, None,
         'Horizontal value-in design units'),
        ('int16', 'YCoordinate', None, None,
    ...
    ('SingleSubstFormat2', [
        ...
        ('GlyphID', 'Substitute', 'GlyphCount', 0,
    ...
    ('MultipleSubstFormat1', [
        ...
        ('Offset', 'Coverage', None, None,
         'Offset to Coverage table-from beginning of Substitution table'),
        ('uint16', 'SequenceCount', None, None,
    ...
    ('Sequence', [
        ...
        ('GlyphID', 'Substitute', 'GlyphCount',
         0, 'String of GlyphIDs to substitute'),
    ]),
    ...
    ('AlternateSubstFormat1', [
        ...
        ('Offset', 'Coverage', None, None,
         'Offset to Coverage table-from beginning of Substitution table'),
        ('uint16', 'AlternateSetCount', None,
         None, 'Number of AlternateSet tables'),
    ...
    ('AlternateSet', [
        ...
        ('GlyphID', 'Alternate', 'GlyphCount', 0,
    ...
    ('SubRule', [
        ...
        ('uint16', 'SubstCount', None, None,
         'Number of SubstLookupRecords'),
        ('GlyphID', 'Input', 'GlyphCount', -1,
         'Array of input GlyphIDs-start with second glyph'),
        ('struct', 'SubstLookupRecord', 'SubstCount', 0,
    ...
    ('ContextSubstFormat2', [
        ...
        ('uint16', 'SubClassSetCount', None,
         None, 'Number of SubClassSet tables'),
    ...
    ('SubClassSet', [
        ('uint16', 'SubClassRuleCount', None,
         None, 'Number of SubClassRule tables'),
    ...
    ('ChainSubRuleSet', [
        ('uint16', 'ChainSubRuleCount', None,
         None, 'Number of ChainSubRule tables'),
    ...
    ('ChainContextSubstFormat2', [
        ...
        ('uint16', 'ChainSubClassSetCount', None,
         None, 'Number of ChainSubClassSet tables'),
    ...
    ('ChainSubClassSet', [
        ('uint16', 'ChainSubClassRuleCount', None,
         None, 'Number of ChainSubClassRule tables'),
    ...
    ('GDEF', [
        ...
        ('LOffset', 'VarStore', None, 'Version >= 0x00010003',
    ...
    ('AttachPoint', [
        ('uint16', 'PointCount', None, None,
         'Number of attachment points on this glyph'),
        ('uint16', 'PointIndex', 'PointCount', 0,
    ...
    ('LigCaretList', [
        ...
        ('uint16', 'LigGlyphCount', None,
         None, 'Number of ligature glyphs'),
    ...
    ('CaretValueFormat1', [
        ...
        ('int16', 'Coordinate', None, None,
         'X or Y value, in design units'),
    ]),

    ('CaretValueFormat2', [
        ('uint16', 'CaretValueFormat', None, None, 'Format identifier-format = 2'),
        ('uint16', 'CaretValuePoint', None,
         None, 'Contour point index on glyph'),
    ]),
    ...
    ('MarkGlyphSetsDef', [
        ...
        ('uint16', 'MarkSetCount', None,
         None, 'Number of mark sets defined'),
        ('LOffset', 'Coverage', 'MarkSetCount', 0,
    ...
    ('BaseScriptList', [
        ('uint16', 'BaseScriptCount', None, None,
    ...
    ('BaseScript', [
        ...
        ('uint16', 'BaseLangSysCount', None, None,
    ...
    ('BaseLangSysRecord', [
        ('Tag', 'BaseLangSysTag', None, None,
         '4-byte language system identification tag'),
        ('Offset', 'MinMax', None, None,
    ...
    ('MinMax', [
        ...
        ('uint16', 'FeatMinMaxCount', None, None,
    ...
    ('BaseCoordFormat2', [
        ...
        ('int16', 'Coordinate', None, None,
         'X or Y value, in design units'),
        ('GlyphID', 'ReferenceGlyph', None,
         None, 'GlyphID of control glyph'),
        ('uint16', 'BaseCoordPoint', None, None,
    ...
    ('JSTF', [
        ...
        ('uint16', 'JstfScriptCount', None, None,
    ...
    ('JstfScript', [
        ...
        ('uint16', 'JstfLangSysCount', None, None,
    ...
    ('ExtenderGlyph', [
        ...
        ('GlyphID', 'ExtenderGlyph', 'GlyphCount', 0,
         'GlyphIDs-in increasing numerical order'),
    ]),

    ('JstfLangSys', [
        ('uint16', 'JstfPriorityCount', None,
         None, 'Number of JstfPriority tables'),
    ...
    ('JstfPriority', [
        ...
        ('Offset', 'ExtensionEnableGSUB', None, None,
        ...
        ('Offset', 'ExtensionEnableGPOS', None, None,
         'Offset to Extension Enable JstfGSUBModList table-may be NULL'),
    ...
    ('STAT', [
        ...
        ('uint16', 'DesignAxisRecordSize', None, None,
         'Size in bytes of each design axis record'),
        ('uint16', 'DesignAxisCount', None,
         None, 'Number of design axis records'),
        ...
        ('uint16', 'AxisValueCount', None,
         None, 'Number of axis value tables'),
    ...
    ('AxisRecord', [
        ...
        ('uint8', 'MoreBytes', 'DesignAxisRecordSize', - \
         8, 'Extra bytes.  Set to empty array.'),
    ]),
    ...
    ('FeatureVariations', [
        ...
        ('uint32', 'FeatureVariationCount', None, None,
         'Number of records in the FeatureVariationRecord array'),
        ('struct', 'FeatureVariationRecord', 'FeatureVariationCount',
         0, 'Array of FeatureVariationRecord'),
    ]),
    ...
    ('ConditionSet', [
        ('uint16', 'ConditionCount', None, None,
         'Number of condition tables in the ConditionTable array'),
        ('LOffset', 'ConditionTable', 'ConditionCount',
         0, 'Array of condition tables.'),
    ]),
    ...
    ('ConditionTableFormat1', [
        ...
        ('F2Dot14', 'FilterRangeMaxValue', None, None,
    ...
    ('FeatureTableSubstitution', [
        ('Version', 'Version', None, None,
         'Version of the table-initially set to 0x00010000'),
        ('uint16', 'SubstitutionCount', None, None,
         'Number of records in the FeatureVariationRecords array'),
        ('FeatureTableSubstitutionRecord', 'SubstitutionRecord',
         'SubstitutionCount', 0, 'Array of FeatureTableSubstitutionRecord'),
    ]),

    ('FeatureTableSubstitutionRecord', [
        ('uint16', 'FeatureIndex', None, None,
    ...
    ('VVAR', [
        ...
        ('LOffsetTo(VarIdxMap)', 'VOrgMap',
         None, None, 'Vertical origin mapping.'),
    ]),
    ...
    ('MetricsValueRecord', [
        ...
        ('uint32', 'VarIdx', None, None,
         'Combined outer-inner variation index'),
        ('uint8', 'MoreBytes', 'ValueRecordSize', - \
         8, 'Extra bytes.  Set to empty array.'),
    ]),
    ...
    ('MathConstants', [
        ...
        ('MathValueRecord', 'AxisHeight', None,
         None, 'Axis height of the font.'),
        ...
        ('MathValueRecord', 'StackTopShiftUp', None, None,
        ...
        ('MathValueRecord', 'FractionNumeratorShiftUp', None,
         None, 'Standard shift up applied to the numerator.'),
    ...
    ('MathKernInfo', [
        ...
        ('uint16', 'MathKernCount', None, None,
    ...
    ('MathGlyphConstruction', [
        ...
        ('uint16', 'VariantCount', None, None,
         'Count of glyph growing variants for this glyph.'),
        ('MathGlyphVariantRecord', 'MathGlyphVariantRecord', 'VariantCount',
         0, 'MathGlyphVariantRecords for alternative variants of the glyphs.'),
    ]),
    ...
    ('AATLookupSegment', [
        ('uint16', 'lastGlyph', None, None,
         'Last glyph index in this segment.'),
        ('uint16', 'firstGlyph', None, None,
         'First glyph index in this segment.'),
        ('uint16', 'value', None, None,
    ...
    ('AnchorPointsFormat0', [
        ...
        ('uint16', 'Flags', None, None,
         'Flags. Currenty unused, set to zero.'),
        ('AATLookupWithDataOffset(AnchorGlyphData)', 'Anchors', None,
         None, 'Table of with anchor overrides for each glyph.'),
    ]),

    ('AnchorGlyphData', [
        ('uint32', 'AnchorPointCount', None, None,
         'Number of anchor points for this glyph.'),
        ('struct', 'AnchorPoint', 'AnchorPointCount',
         0, 'Individual anchor points.'),
    ]),
    ...
    ('BaselineFormat1', [
        ...
        ('uint16', 'DefaultBaseline', None, None,
         'Default baseline value for all glyphs. This value can be from 0 through 31.'),
        ('uint16', 'Delta', 32, 0, u'These are the FUnit distance deltas from the font’s natural baseline to the other baselines used in the font. A total of 32 deltas must be assigned.'),
        ('AATLookup(uint16)', 'BaselineValues', None, None,
    ...
    ('FeatureNames', [
        ('uint16', 'FeatureNameCount', None, None,
        ...
        ('FeatureName', 'FeatureName', 'FeatureNameCount',
         0, 'The feature name array.'),
    ]),

    ('FeatureName', [
        ('uint16', 'FeatureType', None, None, 'Feature type.'),
        ('uint16', 'SettingsCount', None, None,
         'The number of records in the setting name array.'),
        ('LOffset', 'Settings', None, None,
         'Offset to setting table for this feature.'),
        ('uint16', 'FeatureFlags', None, None,
         'Single-bit flags associated with the feature type.'),
        ('NameID', 'FeatureNameID', None, None,
    ...
    ('Setting', [
        ...
        ('NameID', 'SettingNameID', None, None,
    ...
    ('gcid', [
        ('struct', 'GlyphCIDMapping', None,
         None, 'Glyph to CID mapping table.'),
    ]),
    ...
    ('mort', [
        ...
        ('uint32', 'MorphChainCount', None, None,
         'Number of metamorphosis chains.'),
        ('MortChain', 'MorphChain', 'MorphChainCount',
         0, 'Array of metamorphosis chains.'),
    ]),

    ('MortChain', [
        ('Flags32', 'DefaultFlags', None, None,
         'The default specification for subtables.'),
        ('uint32', 'StructLength', None, None,
         'Total byte count, including this header; must be a multiple of 4.'),
        ('uint16', 'MorphFeatureCount', None, None,
         'Number of metamorphosis feature entries.'),
        ('uint16', 'MorphSubtableCount', None, None,
         'The number of subtables in the chain.'),
        ('struct', 'MorphFeature', 'MorphFeatureCount',
         0, 'Array of metamorphosis features.'),
        ('MortSubtable', 'MorphSubtable', 'MorphSubtableCount',
         0, 'Array of metamorphosis subtables.'),
    ]),

    ('MortSubtable', [
        ('uint16', 'StructLength', None, None,
         'Total subtable length, including this header.'),
        ('uint8', 'CoverageFlags', None, None,
    ...
    ('morx', [
        ...
        ('MorxChain', 'MorphChain', 'MorphChainCount',
         0, 'Array of extended metamorphosis chains.'),
    ]),
    ...
    ('MorxChain', [
        ...
        ('uint32', 'StructLength', None, None,
         'Total byte count, including this header; must be a multiple of 4.'),
        ('uint32', 'MorphFeatureCount', None, None,
         'Number of feature subtable entries.'),
        ('uint32', 'MorphSubtableCount', None, None,
         'The number of subtables in the chain.'),
        ('MorphFeature', 'MorphFeature', 'MorphFeatureCount',
         0, 'Array of metamorphosis features.'),
        ('MorxSubtable', 'MorphSubtable', 'MorphSubtableCount',
         0, 'Array of extended metamorphosis subtables.'),
    ]),

    ('MorphFeature', [
        ('uint16', 'FeatureType', None, None, 'The type of feature.'),
        ('uint16', 'FeatureSetting', None, None,
         "The feature's setting (aka selector)."),
        ('Flags32', 'EnableFlags', None, None,
    ...
    ('RearrangementMorph', [
        ('STXHeader(RearrangementMorphAction)', 'StateTable', None,
         None, 'Finite-state transducer table for indic rearrangement.'),
    ]),
    ...
    ('NoncontextualMorph', [
        ('AATLookup(GlyphID)', 'Substitution', None, None,
         'The noncontextual glyph substitution table.'),
    ]),

    ('InsertionMorph', [
        ('STXHeader(InsertionMorphAction)', 'StateTable', None,
         None, 'Finite-state transducer for glyph insertion.'),
    ]),
    ...
    ('GlyphPropertiesFormat1', [
        ...
        ('AATLookup(uint16)', 'Properties', None, None,
    ...
    ('TSIC', [
        ...
        ('uint16', 'Reserved', None, None, 'Set to 0'),
        ('Tag', 'AxisArray', 'AxisCount', 0,
         'Array of axis tags in fvar order'),
        ('LocationRecord', 'RecordLocations', 'RecordCount',
         0, 'Location in variation space of TSIC record'),
    ...
    ('TSICRecord', [
        ...
        ('uint16', 'NumCVTEntries', None, None,
         'Number of CVT number value pairs'),
        ('uint16', 'NameLength', None, None,
    ...
    ('COLR', [
        ('uint16', 'Version', None, None,
         'Table version number (starts at 0).'),
        ('uint16', 'BaseGlyphRecordCount', None,
         None, 'Number of Base Glyph Records.'),
        ('LOffset', 'BaseGlyphRecordArray', None, None,
         'Offset (from beginning of COLR table) to Base Glyph records.'),
        ('LOffset', 'LayerRecordArray', None, None,
         'Offset (from beginning of COLR table) to Layer Records.'),
        ('uint16', 'LayerRecordCount', None,
         None, 'Number of Layer Records.'),
        ('LOffset', 'BaseGlyphV1List', None, 'Version >= 1',
         'Offset (from beginning of COLR table) to array of Version-1 Base Glyph records.'),
        ('LOffset', 'VarStore', None, 'Version >= 1',
         'Offset to variation store (may be NULL)'),
    ]),

    ('BaseGlyphRecordArray', [
        ('BaseGlyphRecord', 'BaseGlyphRecord',
         'BaseGlyphRecordCount', 0, 'Base Glyph records.'),
    ]),
    ...
    ('LayerRecord', [
        ('GlyphID', 'LayerGlyph', None, None,
         'Glyph ID of layer glyph (must be in z-order from bottom to top).'),
        ('uint16', 'PaletteIndex', None, None,
         'Index value to use with a selected color palette.'),
    ]),

    ('BaseGlyphV1List', [
        ('uint32', 'BaseGlyphCount', None, None,
         'Number of Version-1 Base Glyph records'),
        ('struct', 'BaseGlyphV1Record', 'BaseGlyphCount',
         0, 'Array of Version-1 Base Glyph records'),
    ]),

    ('BaseGlyphV1Record', [
        ('GlyphID', 'BaseGlyph', None, None, 'Glyph ID of reference glyph.'),
        ('LOffset', 'LayerV1List', None, None,
         'Offset (from beginning of BaseGlyphV1List) to LayerV1List.'),
    ]),

    ('LayerV1List', [
        ('uint32', 'LayerCount', None, None, 'Number of Version-1 Layer records'),
        ('struct', 'LayerV1Record', 'LayerCount',
         0, 'Array of Version-1 Layer records'),
    ]),
    ...
    ('LayerV1Record', [
        ...
        ('LOffset', 'Paint', None, None,
         'Offset (from beginning of LayerV1List) to Paint subtable.'),
    ]),
    ...
    ('PaintFormat2', [
        ...
        ('LOffset', 'ColorLine', None, None,
         'Offset (from beginning of Paint table) to ColorLine subtable.'),
    ...
    ('PaintFormat3', [
        ...
        ('LOffsetTo(Affine2x2)', 'Transform', None, None,
         'Offset (from beginning of Paint table) to Affine2x2 subtable.'),
    ]),
]
