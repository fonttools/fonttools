...
class table_M_E_T_A_(DefaultTable.DefaultTable):
    ...
    def decompile(self, data, ttFont):
        ...
        for i in range(self.nMetaRecs):
            ...
            if self.metaFlags == 0:
                ...
                assert 0, "The metaFlags field in the META table header has a value other than 0 or 1 :" + \
                    str(self.metaFlags)
            ...
            for j in range(glyphRecord.nMetaEntry):
                ...
                if self.metaFlags == 0:
                    ...
                    newData = newData[4:]
                stringRec.string = data[stringRec.offset:
                                        stringRec.offset + stringRec.stringLen]
    ...
    def compile(self, ttFont):
        ...
        while (offsetOK != 1):
            ...
            stringRecsOffset = len(metaData) + \
                self.nMetaRecs * (6 + 2*(self.metaFlags & 1))
...
class StringRecord(object):
    ...
    def __repr__(self):
        return "StringRecord [ labelID: " + str(self.labelID) + " aka " + getLabelString(self.labelID) \
            + ", offset: " + str(self.offset) + ", length: " + \
            str(self.stringLen) + ", string: " + self.string + " ]"
