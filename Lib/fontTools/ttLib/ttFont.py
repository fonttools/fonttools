...
class TTFont(object):
    ...
    def __init__(self, file=None, res_name_or_index=None,
        ...
        # Can't make it be 0xFFFF, as the world is full unsigned short integer counters that get incremented after the last seen GID value.
    ...
    def _save(self, file, tableCache=None):
        ...
        writer = SFNTWriter(file, numTables, self.sfntVersion,
                            self.flavor, self.flavorData)
    ...
    def _saveXML(self, writer,
        ...
        if writeVersion:
            ...
            writer.begintag("ttFont", sfntVersion=repr(
                tostr(self.sfntVersion))[1:-1])
        writer.newline()
...
def reorderFontTables(inFile, outFile, tableOrder=None, checkChecksums=False):
    ...
    writer = SFNTWriter(outFile, len(reader.tables),
