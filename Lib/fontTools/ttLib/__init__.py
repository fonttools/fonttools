...
class TTFont(object):
	...
	def __init__(self, file=None, res_name_or_index=None,
			...
			recalcTimestamp=True, fontNumber=-1, lazy=None, padGlyphData=False,
			quiet=False):
		...
		If padGlyphData is set to True, the offsets to the locations of the glyphs
		in the 'loca' table will be 'long-aligned', i.e., padded to multiples of 4
		bytes. If it is set to False, only the odd-lengthed offsets will be
		padded to allow loca table to use the 'short' format.
		"""
		...
		self.padGlyphData = padGlyphData
		self.tables = {}
		self.reader = None
